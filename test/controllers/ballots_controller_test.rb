...
class BallotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ballot" do
    assert_difference("Ballot.count") do
      post ballots_url, params: { ballot: { choice: @ballot.choice, exp: @ballot.exp, password_digest: @ballot.password_digest, voter: @ballot.voter, voting_id: @ballot.voting_id } }
    end
  ...
  test "should update ballot" do
    patch ballot_url(@ballot), params: { ballot: { choice: @ballot.choice, exp: @ballot.exp, password_digest: @ballot.password_digest, voter: @ballot.voter, voting_id: @ballot.voting_id } }
